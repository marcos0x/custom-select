...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      main: {
        src: [
          'src/js/jquery.custom-select.js'
        ],
        dest: 'dist/jquery.custom-select.js'
      }
    },
    ...
    uglify: {
      ...
      main: {
        ...
        dest: 'dist/jquery.custom-select.min.js'
      }
    },
    ...
    autoprefixer: {
      ...
      main: {
        ...
        src: 'dist/jquery.custom-select.css'
      }
    },
    ...
    cssmin: {
      ...
      minifyMain: {
        src: 'dist/jquery.custom-select.css',
        dest: 'dist/jquery.custom-select.min.css'
      }
    },
